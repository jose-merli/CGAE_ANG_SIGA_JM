...
export class DatosPersonaJuridicaComponent implements OnInit {
  ...
  cantidadIntegrantes;
  vieneDeFactura: any;
  constructor(public sigaServices: OldSigaServices, private cardService: CardService, private router: Router, private location: Location, private translateService: TranslateService) {}
  ...
  backTo() {
    ...
    } else if (sessionStorage.getItem("filtrosBusquedaNoColegiados") != undefined) {
      this.router.navigate(["fichaColegial"]);
