...
export class DatosRegistralesComponent implements OnInit, OnChanges {
  ...
  constructor(private formBuilder: FormBuilder, private changeDetectorRef: ChangeDetectorRef, private translateService: TranslateService, private sigaServices: SigaServices, private cardService: CardService, private fichasPosibles: DatosPersonaJuridicaComponent, private router: Router, private commonsService: CommonsService) {
  ...
  ngOnChanges(changes: SimpleChanges) {
    ...
    if (changes.cantidadIntegrantes && changes.cantidadIntegrantes != null && changes.cantidadIntegrantes.currentValue == 0 && this.sociedadProfesional == true) {
  ...
  compruebaRegistro() {
    if (Number(this.body.contadorNumsspp) && !this.onlySpaces(this.body.contadorNumsspp)) {
      this.contadorNoCorrecto = false;
      return true;
    } else {
      if (this.body.contadorNumsspp == "" || this.onlySpaces(this.body.contadorNumsspp)) {
  ...
  getActividadesPersona() {
    this.sigaServices.post("datosRegistrales_actividadesPersona", this.body).subscribe(
      (data) => {
    ...
    this.sigaServices.postPaginado("datosRegistrales_search", "?numPagina=1", this.body).subscribe(
      (data) => {
        ...
        if (
          ...
          this.body.identificacionReg == null ||
          this.body.numRegistro == undefined ||
          this.body.numRegistro == "" ||
  ...
  guardar() {
    ...
    if (!this.desactivadoGuardar()) {
      ...
      if ((this.body.contadorNumsspp != undefined && !this.onlySpaces(this.body.contadorNumsspp)) || !this.requiredContador) {
        if (!(this.requiredContador && Number(this.body.contadorNumsspp))) {
          if (!(this.requiredContador && this.body.contadorNumsspp.length <= Number(this.longitudcontador))) {
            ...
            this.showCustomFail("El campo número de registro SIGA no puede ser superior a la longitud del contador: " + this.longitudcontador);
            this.progressSpinner = false;
          }
        } else {
          this.showCustomFail("El campo número de registro SIGA debe ser numérico");
          this.progressSpinner = false;
        }
      } else {
        this.showCustomFail("Las sociedades profesionales deben especificar el número de registro");
        this.progressSpinner = false;
      }
    } else {
  ...
  arreglarFechas() {
    if (this.fechaConstitucion != undefined && this.fechaConstitucion != null) {
      this.body.fechaConstitucion = this.transformaFecha(this.fechaConstitucion);
    } else {
  ...
  habilitarCheck() {
    if (
      (this.body.objetoSocial != undefined && this.body.objetoSocial != "" && !this.onlySpaces(this.body.objetoSocial)) ||
      (this.body.resena != undefined && this.body.resena != "" && !this.onlySpaces(this.body.resena)) ||
      (this.fechaConstitucion != undefined && this.compruebaFechaConstitucion()) ||
      this.fechaInscripcion != undefined ||
      (this.body.numRegistro != undefined && this.body.numRegistro != "" && !this.onlySpaces(this.body.numRegistro)) ||
      (this.body.identificacionReg != undefined && this.body.identificacionReg != "" && !this.onlySpaces(this.body.identificacionReg) && this.body.contadorNumsspp != undefined && this.body.contadorNumsspp != "" && !this.onlySpaces(this.body.contadorNumsspp)) ||
      (this.body.identificacionReg != undefined && this.body.identificacionReg != "" && !this.onlySpaces(this.body.identificacionReg))
    ) {
      // this.sociedadProfesional = true;
  ...
  getNumsspp() {
    ...
    if (this.sociedadProfesional) {
      if (this.body.contadorNumsspp != undefined && this.body.contadorNumsspp != null && this.body.contadorNumsspp != "") {
        this.body.contadorNumsspp = this.fillWithCeros(this.body.contadorNumsspp, Number(this.longitudcontador));
        ...
        this.body.contadorNumsspp = this.fillWithCeros(this.contador, Number(this.longitudcontador));
  ...
  desactivadoGuardar() {
    if (this.sociedadProfesional == true) {
      if (this.body.resena != undefined && !this.onlySpaces(this.body.resena) && this.fechaConstitucion != undefined && this.compruebaFechaConstitucion() && this.body.contadorNumsspp != undefined && !this.onlySpaces(this.body.contadorNumsspp) && this.contadorNoCorrecto == false && this.fechaFinCorrecta != false) {
        if (this.body.resena == undefined || this.onlySpaces(this.body.resena) || this.body.resena.length < 3) {
          this.showCustomFail("La reseña debe tener al menos 3 caracteres.");
          return true;
        }
        ...
        if ((this.body.contadorNumsspp == undefined || this.onlySpaces(this.body.contadorNumsspp) || this.body.contadorNumsspp == null) && this.noEditable) {
  ...
  abreCierraFicha(key) {
    ...
    if ((this.tarjeta == "2" || this.tarjeta == "3") && sessionStorage.getItem("nuevoRegistro") == null && this.colapsarTarjeta) {
  ...
  onChangeSociedadProfesional() {
    ...
    if (this.isNuevo && this.sociedadProfesional) {
      this.body.sociedadProfesional = "1";
      // if (this.modo == "0") {
      this.body.contadorNumsspp = String(this.fillWithCeros(this.contador, Number(this.longitudcontador)));
