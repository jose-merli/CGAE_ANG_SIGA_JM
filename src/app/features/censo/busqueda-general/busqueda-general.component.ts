...
export class BusquedaGeneralComponent implements OnDestroy {
  ...
  constructor(private formBuilder: FormBuilder, private router: Router, private changeDetectorRef: ChangeDetectorRef, private sigaServices: SigaServices, private confirmationService: ConfirmationService, private translateService: TranslateService, private location: Location, private commonsService: CommonsService, private authenticationService: AuthenticationService, private datePipe: DatePipe, private persistenceService: PersistenceService) {
  ...
  ngOnInit() {
    if (sessionStorage.getItem("origin")) {
      ...
      } else if (sessionStorage.getItem("origin") == "AbogadoContrarioEJG") {
        this.fromAbogadoContrarioEJG = true;
      } else if (sessionStorage.getItem("origin") == "newProducto") {
        ...
        this.sigaServices.get("busquedaPer_colegio").subscribe(
          (n) => {
            ...
            if (sessionStorage.getItem("abrirRemitente") == "true") {
              ...
              if (sessionStorage.getItem("AddDestinatarioIndv") || sessionStorage.getItem("abrirRemitente") || sessionStorage.getItem("nuevoNoColegiadoGen") || sessionStorage.getItem("crearnuevo")) {
  ...
  changeColsAndData() {
    ...
    if (this.persona == "f") {
      ...
      if (sessionStorage.getItem("AddDestinatarioIndv") == undefined && sessionStorage.getItem("abrirRemitente") == undefined && sessionStorage.getItem("nuevoNoColegiadoGen") == undefined && sessionStorage.getItem("nuevaDesigna") == undefined) {
        //this.colegios_seleccionados = [];
        this.addDestinatarioIndv = false;
      } else {
        this.addDestinatarioIndv = true;
      ...
      if (sessionStorage.getItem("AddDestinatarioIndv") == undefined && sessionStorage.getItem("abrirRemitente") == undefined && sessionStorage.getItem("nuevoNoColegiadoGen") == undefined && sessionStorage.getItem("crearnuevo") == undefined && sessionStorage.getItem("nuevaDesigna") == undefined) {
        //this.colegios_seleccionados = [];
        this.addDestinatarioIndv = false;
      } else {
        this.addDestinatarioIndv = true;
  ...
  checkFilterFisic() {
    if ((this.colegios_seleccionados == undefined || this.colegios_seleccionados == null || this.colegios_seleccionados.length < 1) && (this.bodyFisica.nif == null || this.bodyFisica.nif == undefined || this.bodyFisica.nif.trim().length < 3)) {
      this.showSearchIncorrect();
      this.progressSpinner = false;
      return false;
    }
    if (
      (this.bodyFisica.nombre == null || this.bodyFisica.nombre == undefined || this.bodyFisica.nombre.trim().length < 3) &&
      (this.bodyFisica.primerApellido == null || this.bodyFisica.primerApellido == undefined || this.bodyFisica.primerApellido.trim().length < 3) &&
      (this.bodyFisica.segundoApellido == null || this.bodyFisica.segundoApellido == undefined || this.bodyFisica.segundoApellido.trim().length < 3) &&
      (this.bodyFisica.numeroColegiado == null || this.bodyFisica.numeroColegiado == undefined || this.bodyFisica.numeroColegiado.trim().length < 3) &&
  ...
  checkFilterJuridic() {
    if ((this.colegios_seleccionados == undefined || this.colegios_seleccionados == null || this.colegios_seleccionados.length < 1) && (this.bodyJuridica.nif == null || this.bodyJuridica.nif == null || this.bodyJuridica.nif.trim().length < 3)) {
      this.showSearchIncorrect();
      this.progressSpinner = false;
      return false;
    }
    if (
      (this.selectedTipo == undefined || this.selectedTipo == null || this.selectedTipo.value == "" || this.selectedTipo.length < 1) &&
      (this.bodyJuridica.abreviatura == null || this.bodyJuridica.abreviatura == null || this.bodyJuridica.abreviatura.trim().length < 3) &&
      (this.bodyJuridica.denominacion == null || this.bodyJuridica.denominacion == null || this.bodyJuridica.denominacion.trim().length < 3) &&
      (this.bodyJuridica.nif == null || this.bodyJuridica.nif == null || this.bodyJuridica.nif.trim().length < 3)
    ) {
      this.showSearchIncorrect();
      this.progressSpinner = false;
      return false;
  ...
  search() {
    ...
    if (this.persona == "f") {
      ...
      if (this.checkFilterJuridic()) {
        ...
        this.sigaServices.postPaginado("busquedaPer_searchJuridica", "?numPagina=1", this.bodyJuridica).subscribe(
          (data) => {
            this.progressSpinner = false;
          ...
          () => {
            if ((this.datos.length == 0 || this.datos == null || this.datos == undefined) && !this.existe) {
  ...
  irFichaColegial(id) {
    ...
    //   this.backTo();
    // }
    else if ((sessionStorage.getItem("newIntegrante") != null || sessionStorage.getItem("newIntegrante") != undefined) && sessionStorage.getItem("abrirRemitente") != "true") {
          ...
          if (this.continue == true) {
            ...
            if (sessionStorage.getItem("nuevoNoColegiadoGen") == "true") {
              ...
              if (id[0].numeroInstitucion == this.authenticationService.getInstitucionSession()) {
                ...
                this.sigaServices.postPaginado("busquedaNoColegiados_searchNoColegiado", "?numPagina=1", body).subscribe(
                  (data) => {
                    this.progressSpinner = false;
                    sessionStorage.setItem("esColegiado", "false");
            ...
            if (sessionStorage.getItem("nuevoNoColegiadoGen") == "true") {
              this.showFail("No se puede crear un no colegiado a partir de un colegiado de la misma institución");
            } else {
              this.showFail("No se puede crear una solicitud a partir de una persona de la misma institución");
            }
          }
        },
      );
      ...
      if (sessionStorage.getItem("backInscripcion") != null || sessionStorage.getItem("backInscripcion") != undefined) {
        this.router.navigate(["/buscarInscripciones"]);
        sessionStorage.removeItem("backInscripcion");
      } else if (sessionStorage.getItem("backFichaInscripcion") != null || sessionStorage.getItem("backFichaInscripcion") != undefined) {
    ...
    } else if (sessionStorage.getItem("nuevaSancion") != null && sessionStorage.getItem("nuevaSancion") != undefined) {
          ...
          if (sessionStorage.getItem("nuevoNoColegiadoGen") == "true" || sessionStorage.getItem("busquedaColegiadoDesigna") == "true") {
            ...
            if (sessionStorage.getItem("abrirNotario") == "true") {
              ...
              if (this.bodyFisica.nif != undefined || this.bodyFisica.nif != "") {
                ...
                this.showFail("No se puede crear una solicitud de modificación a partir de una persona jurídica");
              }
            } else if (sessionStorage.getItem("newIntegrante") != null || sessionStorage.getItem("newIntegrante") != undefined) {
              ...
              this.router.navigate(["detalleIntegrante"]);
            } else if (sessionStorage.getItem("abrirFormador") != null || sessionStorage.getItem("abrirFormador") != undefined) {
              ...
              if (sessionStorage.getItem("backFichaInscripcion") != null && sessionStorage.getItem("backFichaInscripcion")) this.router.navigate(["/fichaInscripcion"]);
              else this.router.navigate(["/fichaCurso"]);
            } else if (sessionStorage.getItem("crearnuevo") != null || sessionStorage.getItem("crearnuevo") != undefined) {
              let cuerpo = [];
