...
export class BusquedaColegiadosComponent extends SigaWrapper implements OnInit {
	...
	ngOnInit() {
		...
		if (sessionStorage.getItem('filtrosBusquedaColegiadosFichaColegial') != null) {
			this.body = JSON.parse(sessionStorage.getItem('filtrosBusquedaColegiadosFichaColegial'));
	...
	irEditarColegiado(id) {
		if (id.length >= 1 && this.selectMultiple == false) {
			...
			sessionStorage.setItem('filtrosBusquedaColegiados', JSON.stringify(this.body));
			sessionStorage.removeItem('fechaIncorporacionDesdeSelect');
			if (this.fechaIncorporacionDesdeSelect != null || this.fechaIncorporacionDesdeSelect != undefined) {
			...
			sessionStorage.removeItem('fechaIncorporacionHastaSelect');
			if (this.fechaIncorporacionHastaSelect != null || this.fechaIncorporacionHastaSelect != undefined) {
				sessionStorage.setItem(
	...
	onChangeCodigoPostal(event) {
		if (this.isValidCodigoPostal() && this.body.codigoPostal.length == 5) {
			...
			if (value != this.body.idProvincia || this.body.idProvincia == undefined) {
	...
	getComboResidencia() {
		this.comboResidencia = [ { label: 'Sí', value: 1 }, { label: 'No', value: 0 } ];
	...
	getComboSexo() {
		this.comboSexo = [ { label: 'Hombre', value: 'H' }, { label: 'Mujer', value: 'M' } ];
	}
	...
	getComboTipoCurricular(idTipoCV) {
		this.sigaServices.getParam('busquedaColegiados_getCurricularTypeCombo', '?idTipoCV=' + idTipoCV).subscribe(
			(n) => {
	...
	getComboSubtipoCurricular(idTipoCV) {
		this.sigaServices.getParam('busquedaColegiados_getCurricularSubtypeCombo', '?idTipoCV=' + idTipoCV).subscribe(
			(n) => {
	...
	isBuscar() {
		if (this.checkFilters()) {
			...
			this.sigaServices.postPaginado('busquedaColegiados_searchColegiado', '?numPagina=1', this.body).subscribe(
				(data) => {
	...
	checkFilters() {
		if (
			(this.body.nombre == null || this.body.nombre == null || this.body.nombre.trim().length < 3) &&
			(this.body.apellidos == null || this.body.apellidos == null || this.body.apellidos.trim().length < 3) &&
			...
			(this.body.nif == null || this.body.nif == null || this.body.nif.trim().length < 3) &&
			(this.body.correo == null || this.body.correo == null || this.body.correo.trim().length < 3) &&
			(this.body.movil == null || this.body.movil == null || this.body.movil.trim().length < 3) &&
			(this.body.telefono == null || this.body.telefono == null || this.body.telefono.trim().length < 3) &&
			(this.body.idgrupo == undefined || this.body.idgrupo == null || this.body.idgrupo.length < 1) &&
			(this.fechaIncorporacionDesdeSelect == undefined || this.fechaIncorporacionDesdeSelect == null) &&
			(this.fechaIncorporacionHastaSelect == undefined || this.fechaIncorporacionHastaSelect == null) &&
			...
			(this.body.idEstadoCivil == undefined || this.body.idEstadoCivil == null) &&
			(this.fechaNacimientoDesdeSelect == undefined || this.fechaNacimientoDesdeSelect == null) &&
			(this.fechaNacimientoHastaSelect == undefined || this.fechaNacimientoHastaSelect == null) &&
			(this.body.tipoCV == undefined || this.body.tipoCV == null) &&
			(this.body.subtipoCV == undefined || this.body.subtipoCV == null || this.body.subtipoCV.length < 1) &&
