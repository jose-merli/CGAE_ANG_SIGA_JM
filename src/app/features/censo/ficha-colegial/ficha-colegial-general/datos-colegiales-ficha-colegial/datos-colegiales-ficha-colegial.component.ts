...
import { Calendar, DataTable, Dialog } from "primeng/primeng";
...
export class DatosColegialesFichaColegialComponent implements OnInit, OnChanges {
  ...
  constructor(private sigaServices: SigaServices, private confirmationService: ConfirmationService, private translateService: TranslateService, private changeDetectorRef: ChangeDetectorRef, private commonService: CommonsService) {}
  ...
  ngOnInit() {
    ...
    if (this.colegialesBody.numColegiado == null || this.colegialesBody.numColegiado == undefined || this.colegialesBody.numColegiado === "" || this.colegialesBody.incorporacion == null || this.colegialesBody.incorporacion == undefined || this.colegialesBody.fechapresentacion == null || this.colegialesBody.fechapresentacion == undefined) {
      this.resaltadoDatosColegiales = true;
  ...
  onInitGenerales() {
    ...
    this.sigaServices.get("fichaPersona_tipoIdentificacionCombo").subscribe(
      (n) => {
        ...
        this.tipoIdentificacion[4].label = this.tipoIdentificacion[4].label + " / " + this.tipoIdentificacion[3].label;
      },
      (err) => {
        //console.log(err);
      },
    ...
    let tratamiento = this.generalTratamiento.find((item) => item.value === this.generalBody.idTratamiento);
  ...
  pasarFechas() {
    ...
    if (this.isCrearColegial == true) {
      this.nuevoEstadoColegial.fechaEstado = this.arreglarFecha(this.nuevoEstadoColegial.fechaEstadoStr);
    }
  }
  arreglarFecha(fecha) {
  ...
  activarRestablecerColegiales() {
    if (JSON.stringify(this.checkColegialesBody) != JSON.stringify(this.colegialesBody) || this.isCrearColegial == true || this.isRestablecer == true) {
  ...
  mostrarFechas() {
    if (JSON.stringify(this.colegialesBody.incorporacion) != undefined && JSON.stringify(this.colegialesBody.incorporacion) != null && JSON.stringify(this.colegialesBody.incorporacion).length > 13) {
      this.datePipeIncorporacion = true;
    } else {
      this.datePipeIncorporacion = false;
    }
    if (JSON.stringify(this.colegialesBody.fechapresentacion) != undefined && JSON.stringify(this.colegialesBody.fechapresentacion) != null && JSON.stringify(this.colegialesBody.fechapresentacion).length > 13) {
      this.datePipePresentacion = true;
    } else {
      this.datePipePresentacion = false;
    }
    if (JSON.stringify(this.colegialesBody.fechaJura) != undefined && JSON.stringify(this.colegialesBody.fechaJura) != null && JSON.stringify(this.colegialesBody.fechaJura).length > 13) {
      this.datePipeFechaJura = true;
    } else {
      this.datePipeFechaJura = false;
    }
    if (JSON.stringify(this.colegialesBody.fechaTitulacion) != undefined && JSON.stringify(this.colegialesBody.fechaTitulacion) != null && JSON.stringify(this.colegialesBody.fechaTitulacion).length > 13) {
  ...
  activacionGuardarColegiales() {
    if (this.colegialesBody.situacionResidente == undefined && this.datosColegiales[0].situacionResidente != undefined) this.colegialesBody.situacionResidente = this.datosColegiales[0].situacionResidente;
    this.inscritoAItem();
    this.mostrarFechas();
    if (
      ...
      if (this.isCrearColegial == false) {
        ...
        if (this.nuevoEstadoColegial.situacion != "" && this.nuevoEstadoColegial.situacion != undefined && this.nuevoEstadoColegial.situacionResidente != "" && this.nuevoEstadoColegial.situacionResidente != undefined && this.nuevoEstadoColegial.fechaEstadoStr != "" && this.nuevoEstadoColegial.fechaEstadoStr != undefined) {
          this.activarGuardarColegiales = true;
        } else {
      ...
      if (this.isCrearColegial == false) {
        ...
        if (JSON.stringify(colegialesSinEditar) != JSON.stringify(this.checkDatosColegiales) && this.datosColegiales[0].fechaEstadoStr != null && this.datosColegiales[0].idEstado != "" && this.datosColegiales[0].idEstado != null && this.colegialesBody.situacionResidente != "0" && this.colegialesBody.situacionResidente != undefined && this.colegialesBody.situacionResidente != "") {
          this.activarGuardarColegiales = true;
        } else {
          this.activarGuardarColegiales = false;
        }
        ...
        this.nuevoEstadoColegial.situacion != "" &&
        this.nuevoEstadoColegial.situacion != undefined &&
        this.nuevoEstadoColegial.situacionResidente != "" &&
        this.nuevoEstadoColegial.situacionResidente != undefined &&
        this.nuevoEstadoColegial.fechaEstadoStr != "" &&
        this.nuevoEstadoColegial.fechaEstadoStr != undefined
      ) {
        this.activarGuardarColegiales = true;
      } else {
        if (JSON.stringify(this.datosColegiales) != JSON.stringify(this.checkDatosColegiales) && this.nuevoEstadoColegial.situacion != "" && this.nuevoEstadoColegial.situacion != undefined && this.nuevoEstadoColegial.situacionResidente != "" && this.nuevoEstadoColegial.situacionResidente != undefined && this.nuevoEstadoColegial.fechaEstadoStr != "" && this.nuevoEstadoColegial.fechaEstadoStr != undefined) {
          this.activarGuardarColegiales = true;
        } else {
          this.activarGuardarColegiales = false;
        }
  ...
  searchColegiales() {
    ...
    this.sigaServices.postPaginado("fichaDatosColegiales_datosColegialesSearch", "?numPagina=1", this.generalBody).subscribe(
      (data) => {
      ...
      () => {
        if (this.generalBody.colegiado) {
          this.sigaServices.postPaginado("fichaDatosColegiales_datosColegialesSearchActual", "?numPagina=1", this.generalBody).subscribe((data) => {
            // this.datosColegiales = JSON.parse(data["body"]);
            // this.datosColegiales = this.datosColegiales.colegiadoItem;
  ...
  guardarColegiales() {
    ...
    if (this.colegialesBody.numColegiado != this.checkColegialesBody.numColegiado) {
      if (!(this.colegialesBody.numColegiado == this.maxNumColegiado)) {
        ...
        this.sigaServices.post("solicitudIncorporacion_searchNumColegiado", this.solicitudEditar).subscribe(
          (data) => {
  ...
  comprobarDirecciones() {
    ...
    if (this.isCrearColegial == true) {
      ...
      if (this.datosColegialesInit[0].idEstado == "20" && (this.nuevoEstadoColegial.situacion == "30" || this.nuevoEstadoColegial.situacion == "60") && (this.datosColegialesInit[0].situacionResidente == "1" || this.datosColegialesInit[0].situacionResidente == "Si")) {
        ...
        this.sigaServices.post("fichaDatosColegiales_datosColegialesSearchHistor", this.generalBody).subscribe((data) => {
          ...
          datosColegialesActualSpec.forEach((datColActuIte) => {
            if (datColActuIte.idEstado == "20" && (datColActuIte.situacionResidente == "0" || datColActuIte.situacionResidente == "No")) {
              matchOtherEjerResi = true;
            }
          });

          if (matchOtherEjerResi) {
            this.callServiceShowMessageAndIconCustomized(this.translateService.instant("fichacolegial.cambiosituacion_ejer_res_bajacolegial.warning"), "fa fa-warning", "cambioSituacionColegiado");
          } else {
            this.callServiceGuardarColegiales();
          }
        });
      } else if (this.nuevoEstadoColegial.situacion == "20" && this.datosColegiales[1].idEstado == "20" && (this.datosColegialesInit[0].situacionResidente == "1" || this.datosColegialesInit[0].situacionResidente == "Si") && (this.nuevoEstadoColegial.situacionResidente == "0" || this.nuevoEstadoColegial.situacionResidente == "No")) {
        ...
        this.sigaServices.post("fichaDatosColegiales_datosColegialesSearchHistor", this.generalBody).subscribe((data) => {
          ...
          datosColegialesActualSpec.forEach((datColActuIte) => {
            if (datColActuIte.idEstado == "20" && (datColActuIte.situacionResidente == "1" || datColActuIte.situacionResidente == "Si")) {
              matchOtherEjerNoResi = true;
            }
          });

          if (!matchOtherEjerNoResi || (!matchOtherEjerNoResi && datosColegialesActualSpec.length < 1)) {
            this.callServiceShowMessageAndIconCustomized(this.translateService.instant("fichacolegial.cambiosituacion_ejer_res_ejer_nores.warning"), "fa fa-warning", "cambioSituacionColegiado");
          } else {
            this.callServiceGuardarColegiales();
          }
        });
      ...
      } else if (this.nuevoEstadoColegial.situacion == "20" && this.datosColegiales[1].idEstado == "20" && (this.datosColegialesInit[0].situacionResidente == "0" || this.datosColegialesInit[0].situacionResidente == "No") && (this.nuevoEstadoColegial.situacionResidente == "1" || this.nuevoEstadoColegial.situacionResidente == "Si")) {
            ...
            this.msgs = [
              {
                ...
                detail: this.translateService.instant("fichacolegial.cambiosituacion_ejer-no-res_a_ejer-res.error"),
              },
            ];
          } else {
            this.callServiceGuardarColegiales();
      ...
      } else if (this.nuevoEstadoColegial.situacion == "10" && this.datosColegiales[1].idEstado == "20" && (this.datosColegialesInit[0].situacionResidente == "1" || this.datosColegialesInit[0].situacionResidente == "Si")) {
        ...
        this.sigaServices.post("fichaDatosColegiales_datosColegialesSearchHistor", this.generalBody).subscribe((data) => {
          ...
          if (matchOtherEjerNoResi) {
            this.callServiceShowMessageAndIconCustomized(this.translateService.instant("fichacolegial.cambiosituacion_ejer_res_noejer.warning"), "fa fa-warning", "cambioSituacionColegiado");
          } else {
            this.callServiceGuardarColegiales();
          }
        });
      ...
      } else if ((this.nuevoEstadoColegial.situacion == "40" || this.nuevoEstadoColegial.situacion == "50") && this.datosColegiales[1].idEstado == "20") {
        ...
        this.sigaServices.post("fichaDatosColegiales_datosColegialesSearchHistor", this.generalBody).subscribe((data) => {
          ...
          if (this.arrayAvisosColegios.length > 0) {
            this.callServiceSendMailsOtherCentres(this.translateService.instant("fichacolegial.cambiosituacion_ejer_ina_susp_envio_mail.info"), "fa fa-info", "cambioSituacionColegiado", this.arrayAvisosColegios);
      ...
      } else if (this.nuevoEstadoColegial.situacion == "20" && (this.nuevoEstadoColegial.situacionResidente == "1" || this.nuevoEstadoColegial.situacionResidente == "Si") && (this.datosColegiales[1].idEstado == "10" || this.datosColegiales[1].idEstado == "30" || this.datosColegiales[1].idEstado == "40" || this.datosColegiales[1].idEstado == "50")) {
            ...
            this.msgs = [
              {
                severity: "error",
                summary: this.translateService.instant("general.message.incorrect"),
                detail: this.translateService.instant("fichacolegial.cambiosituacion_noejer-baja-inha-susp_ejer_res.error"),
              },
            ];
          } else {
            this.callServiceGuardarColegiales();
      ...
      } else if (this.nuevoEstadoColegial.situacion == "20" && (this.nuevoEstadoColegial.situacionResidente == "0" || this.nuevoEstadoColegial.situacionResidente == "No") && (this.datosColegiales[1].idEstado == "10" || this.datosColegiales[1].idEstado == "30" || this.datosColegiales[1].idEstado == "40" || this.datosColegiales[1].idEstado == "50")) {
            ...
            this.msgs = [
              {
                severity: "error",
                summary: this.translateService.instant("general.message.incorrect"),
                detail: this.translateService.instant("fichacolegial.cambiosituacion_noejer-baja-inha-susp_ejer_nores.error"),
              },
            ];
          } else {
            this.callServiceGuardarColegiales();
      ...
      //Si el cambio pertenece de un colegiado "Ejerciente Residente -> Baja Colegial"
      if (this.datosColegialesInit[0].idEstado == "20" && (this.datosColegiales[0].idEstado == "30" || this.datosColegiales[0].idEstado == "60") && (this.datosColegialesInit[0].situacionResidente == "1" || this.datosColegialesInit[0].situacionResidente == "Si")) {
      ...
      } else if (this.datosColegiales[0].idEstado == "20" && this.datosColegialesInit[0].idEstado == "20" && (this.datosColegialesInit[0].situacionResidente == "1" || this.datosColegialesInit[0].situacionResidente == "Si") && (this.datosColegiales[0].situacionResidente == "0" || this.datosColegiales[0].situacionResidente == "No")) {
        ...
        // Cambio de situación de un ejerciente no residente a residente || --> NO PERMITIR
      } else if (this.datosColegiales[0].idEstado == "20" && this.datosColegialesInit[0].idEstado == "20" && (this.datosColegialesInit[0].situacionResidente == "0" || this.datosColegialesInit[0].situacionResidente == "No") && (this.datosColegiales[0].situacionResidente == "1" || this.datosColegiales[0].situacionResidente == "Si")) {
        ...
        // Cambio de situación de un ejerciente residente a no ejerciente || --> AVISAR Y PREGUNTAR
      } else if (this.datosColegiales[0].idEstado == "10" && this.datosColegialesInit[0].idEstado == "20" && (this.datosColegialesInit[0].situacionResidente == "1" || this.datosColegialesInit[0].situacionResidente == "Si")) {
        ...
        // Cambio de situación de un ejerciente (residente o no) a Inhabilitación o Suspensión ejercicio || --> AVISAR A OTROS COLEGIOS
      } else if ((this.datosColegiales[0].idEstado == "40" || this.datosColegiales[0].idEstado == "50") && this.datosColegialesInit[0].idEstado == "20") {
        ...
        // Cambio de situación de No ejerciente, Baja colegial, Inhabilitación o Suspensión de ejercicio a Ejerciente Residente || --> NO PERMITIR
      } else if (this.datosColegiales[0].idEstado == "20" && (this.datosColegiales[0].situacionResidente == "1" || this.datosColegiales[0].situacionResidente == "Si") && (this.datosColegialesInit[0].idEstado == "10" || this.datosColegialesInit[0].idEstado == "30" || this.datosColegialesInit[0].idEstado == "40" || this.datosColegialesInit[0].idEstado == "50")) {
        ...
        // Cambio de situación de No ejerciente, Baja colegial, Inhabilitación o Suspensión de ejercicio a Ejerciente no Residente || --> NO PERMITIR
      } else if (this.datosColegiales[0].idEstado == "20" && (this.datosColegiales[0].situacionResidente == "0" || this.datosColegiales[0].situacionResidente == "No") && (this.datosColegialesInit[0].idEstado == "10" || this.datosColegialesInit[0].idEstado == "30" || this.datosColegialesInit[0].idEstado == "40" || this.datosColegialesInit[0].idEstado == "50")) {
      ...
      } else if (this.datosColegiales[0].idEstado == "20" && this.datosColegialesInit[0].idEstado == "20" && this.datosColegialesInit[0].situacionResidente != this.datosColegiales[0].situacionResidente) {
        let matchOtherEjerNoResi = false,
          matchOtherEjerResi = false;
        this.sigaServices.post("fichaDatosColegiales_datosColegialesSearchHistor", this.generalBody).subscribe((data) => {
          let colegialesObjectSpec = JSON.parse(data["body"]);
          let datosColegialesActualSpec = colegialesObjectSpec.colegiadoItem;
          ...
          datosColegialesActualSpec.forEach((datColActuIte) => {
            if (datColActuIte.idEstado == "20" && (datColActuIte.situacionResidente == "0" || datColActuIte.situacionResidente == "No")) {
              matchOtherEjerNoResi = true;
            } else if (datColActuIte.idEstado == "20" && (datColActuIte.situacionResidente == "1" || datColActuIte.situacionResidente == "Si")) {
              matchOtherEjerResi = true;
            }
          });
            ...
            this.msgs = [
              {
                severity: "error",
                summary: this.translateService.instant("general.message.incorrect"),
                detail: this.translateService.instant("fichacolegial.cambiosituacion_ejer-doble-resi.error"),
              },
            ];
            ...
            this.msgs = [
              {
                severity: "error",
                summary: this.translateService.instant("general.message.incorrect"),
                detail: this.translateService.instant("fichacolegial.cambiosituacion_ejer-sin-resi.error"),
              },
            ];
          } else {
            this.callServiceGuardarColegiales();
  ...
  sendMailsOtherCentres(centresToSendMail: any[]) {
    this.sigaServices.post("fichaDatosColegiales_sendMailsOtherCentres", centresToSendMail).subscribe((data) => {
      this.callServiceGuardarColegiales();
    });
  }
      ...
      this.sigaServices.postPaginado("fichaDatosDirecciones_datosDireccionesSearch", "?numPagina=1", this.bodyDirecciones).subscribe(
        (data) => {
          ...
          this.datosDirecciones.forEach((element) => {
            let numDespacho = element.idTipoDireccion.find((item) => item == "2");
  ...
  callServiceGuardarColegiales() {
    ...
    this.sigaServices.post("fichaDatosColegiales_datosColegialesUpdateMasivo", update).subscribe(
      (data) => {
        //Se comprueba si se han realizado cambios en los datos colegiales
        if (this.colegialesBody != this.checkColegialesBody) {
        ...
        if (JSON.parse(data.body).error != null && JSON.parse(data.body).error != undefined && JSON.parse(data.body).error != "") {
  ...
  obtenerEtiquetasPersonaJuridicaConcreta() {
    this.sigaServices.post("fichaDatosGenerales_etiquetasPersona", this.generalBody).subscribe(
      (n) => {
        // coger etiquetas de una persona juridica
        this.etiquetasPersonaJuridica = JSON.parse(n["body"]).comboEtiquetasItems;
        ...
        this.etiquetasPersonaJuridicaSelecionados.forEach((value: any, index: number) => {
  ...
  comprobarCamposColegiales() {
    ...
    if (
      this.colegialesBody.numColegiado == null ||
      this.colegialesBody.numColegiado == undefined ||
      this.colegialesBody.numColegiado === "" ||
      this.colegialesBody.incorporacion == null ||
      this.colegialesBody.incorporacion == undefined ||
      this.colegialesBody.fechapresentacion == null ||
      this.colegialesBody.fechapresentacion == undefined ||
      this.inscritoSeleccionado == null ||
      this.inscritoSeleccionado == undefined ||
      this.inscritoSeleccionado === "" ||
      (this.datosColegiales.length > 0 && (!this.nuevoEstadoColegial.fechaEstadoStr || !this.nuevoEstadoColegial.situacion || !this.nuevoEstadoColegial.situacionResidente) && this.isCrearColegial)
    ) {
  ...
  comprobarTurnosGuardias(tipoCambio): void {
    ...
    this.sigaServices.post("fichaDatosColegiales_searchTurnosGuardias", this.colegialesBody).subscribe(
      (data) => {
        let resultado = JSON.parse(data["body"]);
  ...
  onChangeDropEstadoColegial(event, selectedDatos) {
    if (!this.isCrearColegial && event.value != null && event.value != undefined) {
      let identificacion = this.comboSituacion.find((item) => item.value === event.value);
  ...
  comprobarCampoMotivo() {
    if (this.generalBody.motivo != undefined && this.generalBody.motivo != "" && this.generalBody.motivo.trim() != "") {
  ...
  callServiceEliminarEstadoColegial(selectedItem) {
    ...
    this.sigaServices.post("fichaDatosColegiales_datosColegialesDeleteEstado", selectedItem).subscribe(
      (data) => {
        this.progressSpinner = false;
        this.isCrearColegial = false;
        this.isRestablecer = false;
