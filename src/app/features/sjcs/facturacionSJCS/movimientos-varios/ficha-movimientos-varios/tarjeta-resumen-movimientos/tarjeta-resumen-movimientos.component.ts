...
@Component({
  selector: 'app-tarjeta-resumen-movimientos',
  templateUrl: './tarjeta-resumen-movimientos.component.html',
  styleUrls: ['./tarjeta-resumen-movimientos.component.scss']
})
export class TarjetaResumenMovimientosComponent implements OnInit {
