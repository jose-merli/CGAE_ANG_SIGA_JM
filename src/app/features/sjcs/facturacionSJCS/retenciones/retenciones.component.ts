...
export class RetencionesComponent implements OnInit {
  ...
  @ViewChild(TablaBusquedaRetencionesComponent) tabla: TablaBusquedaRetencionesComponent;
  ...
  buscarRetenciones(historico: boolean, event?: RetencionesRequestDto) {
    ...
    this.sigaServices.post("retenciones_buscarRetenciones", this.filtros).subscribe(
      data => {
        ...
        if (res.error != null && res.error.description != null && res.error.code != null && res.error.code == 500) {
          ...
          if (res.error != null && res.error.description != null && res.error.code != null && res.error.code == 200) {
