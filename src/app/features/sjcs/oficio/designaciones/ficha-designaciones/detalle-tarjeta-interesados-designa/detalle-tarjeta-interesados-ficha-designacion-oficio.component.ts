...
export class DetalleTarjetaInteresadosFichaDesignacionOficioComponent implements OnInit {
  ...
  constructor(private sigaServices: SigaServices, private translateService: TranslateService, private changeDetectorRef: ChangeDetectorRef, private persistenceService: PersistenceService, private router: Router, private confirmationService: ConfirmationService) {}
  ...
  comunicar() {
    ...
    this.sigaServices.post("dialogo_claseComunicacion", rutaPri).subscribe(
      (data) => {
