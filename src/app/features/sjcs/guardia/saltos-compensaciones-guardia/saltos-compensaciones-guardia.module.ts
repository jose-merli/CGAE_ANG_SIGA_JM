...
@NgModule({
  imports: [CommonModule, DataTableModule, PaginatorModule, InputTextModule, ButtonModule, DropdownModule, CheckboxModule, FormsModule, GrowlModule, PipeTranslationModule, MenubarModule, TableModule, TreeTableModule, MultiSelectModule, PrecioModule, TarjetaResumenFijaModule, TablaDinamicaModule, PickListModule, TablaDinamicaColaGuardiaModule, ConfirmDialogModule, BusquedaColegiadoExpressModule, SelectorModule, MatSortModule, FechaModule, Paginador2Module, PaginadorModule],
  declarations: [SaltosCompensacionesGuardiaComponent, FiltrosSaltosCompensacionesGuardiaComponent, TablaResultadoMixSaltosCompGuardiaComponent, TablaSaltosCompensacionesGuardiaComponent],
  providers: [ImagePipe, DatePipe, TrimPipePipe, UpperCasePipe, SigaServices, CommonsService, MessageService, AuthenticationService, ConfirmationService, TablaResultadoMixSaltosCompService],
