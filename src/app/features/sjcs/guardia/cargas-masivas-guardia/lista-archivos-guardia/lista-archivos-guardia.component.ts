...
@Component({
  selector: 'app-lista-archivos-guardia',
  templateUrl: './lista-archivos-guardia.component.html',
  styleUrls: ['./lista-archivos-guardia.component.scss']
})
export class ListaArchivosGuardiaComponent implements OnInit {
