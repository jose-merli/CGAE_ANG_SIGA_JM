...
export class TablaGuardiaColegiadoComponent implements OnInit {
  ...
  constructor(private translateService: TranslateService, private router: Router, private sigaServices: SigaServices, private persistenceService: PersistenceService, private confirmationService: ConfirmationService, private changeDetectorRef: ChangeDetectorRef) {}
  ...
  confirmValidar(selectedDatos) {
    this.confirmationService.confirm({
      message: "¿Seguro que desea validar esta Guardia?",
      icon: "fa fa-edit",
      accept: () => {
  ...
  confirmDesValidar(selectedDatos) {
    this.confirmationService.confirm({
      message: "¿Seguro que desea desvalidar esta Guardia?",
      icon: "fa fa-edit",
      accept: () => {
