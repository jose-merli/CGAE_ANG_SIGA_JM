...
@Component({
  selector: 'app-datos-generales-comisaria',
  templateUrl: './datos-generales-comisaria.component.html',
  styleUrls: ['./datos-generales-comisaria.component.scss']
})
export class DatosGeneralesComisariaComponent implements OnInit, AfterViewInit {


  //Resultados de la busqueda
  @Input() datos: ComisariaItem;
  @Input() modoEdicion;
