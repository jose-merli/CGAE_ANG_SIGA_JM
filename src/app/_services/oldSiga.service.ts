...
export class OldSigaServices {
	oldServices = {
		...
		calendarioLaboral: 'Dispatcher.do?proceso=C_938',
		...
		guardiasAsistencias: 'Dispatcher.do?proceso=C_952',
		guardiasAsistenciasExpres: 'Dispatcher.do?proceso=C_952',
		guardiasAceptadasCentralita: 'Dispatcher.do?proceso=C_956',
		volanteExpres: 'Dispatcher.do?proceso=C_11A',
		soj: 'Dispatcher.do?proceso=941',
		ejg: 'Dispatcher.do?proceso=C_946',
		gestionActas: 'Dispatcher.do?proceso=C_947',
		...
		comunicaPreparacion: 'Dispatcher.do?proceso=C_12B',
		comunicaRemesaEnvio: 'Dispatcher.do?proceso=C_12C',
		comunicaRemesaResultado: 'Dispatcher.do?proceso=C_12Z',
		comunicaEnvioActualizacion: 'Dispatcher.do?proceso=12W',
		comunicaInfoEconomica: 'Dispatcher.do?proceso=12Y',
		comunicaCarga: 'Dispatcher.do?proceso=C_12X',
		comunicaResoluciones: 'Dispatcher.do?proceso=C_12F',
		comunicaDesignaciones: 'Dispatcher.do?proceso=C_12G',
