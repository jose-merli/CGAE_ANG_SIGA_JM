...
export class SigaServices {
  ...
  endpoints = {
    ...
    modelos_detalle_plantillas: 'modelos/detalle/plantillasEnvio',
    modelos_detalle_plantillasHist: 'modelos/detalle/plantillasEnvioHist',
    modelos_detalle_borrarPlantilla: 'modelos/detalle/borrarPlantilla',
    modelos_detalle_guardarPlantilla: 'modelos/detalle/guardarPlantilla',
