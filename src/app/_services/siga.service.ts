...
export class SigaServices {
  ...
  endpoints = {
    ...
    solicitudModificacion_processGeneralModificationRequest: "solicitudModificacion/processGeneralModificationRequest",
    solicitudModificacion_denyGeneralModificationRequest: "solicitudModificacion/denyGeneralModificationRequest",
    solicitudModificacion_insertGeneralModificationRequest: "solicitudModificacion/insertGeneralModificationRequest",
    // ESPECÍFICA
    ...
    solicitudModificacion_searchSolModifDatosBancariosDetail: "solicitudModificacion/searchSolModifDatosBancariosDetail",
    ...
    solicitudModificacion_searchSolModifDatosCurricularesDetail: "solicitudModificacion/searchSolModifDatosCurricularesDetail",
    solicitudModificacion_processSolModifDatosCurriculares: "solicitudModificacion/processSolModifDatosCurriculares",
    ...
    solicitudModificacion_searchSolModifDatosDireccionesDetail: "solicitudModificacion/searchSolModifDatosDireccionesDetail",
    ...
    solicitudModificacion_searchSolModifDatosGeneralesDetail: "solicitudModificacion/searchSolModifDatosGeneralesDetail",
    solicitudModificacion_searchSolModifDatosCambiarFotoDetail: "solicitudModificacion/searchSolModifDatosCambiarFotoDetail",
    ...
    solicitudModificacion_searchSolModifDatosUseFotoDetail: "solicitudModificacion/searchSolModifDatosUseFotoDetail",
    ...
    fichaDatosGenerales_datosGeneralesSolicitudModificación: "/fichaDatosGenerales/datosGeneralesSolicitudModificación",
    ...
    dialogo_modelosComunicacionConConsultaDestinatarios: "dialogoComunicacion/modelosSearchConConsultaDestinatarios",
  ...
  getDownloadFiles(service: string, body: any): any {
    return this.http.post(environment.newSigaUrl + this.endpoints[service], body, { observe: "response", responseType: "blob" }); // Si no funciona, poner "observe: 'response'" antes del responseType
  }
  ...
  postSendFileAndIdSolicitud(service: string, documentos: File[], documentosInfo: DocumentacionIncorporacionItem[], idSolicitud: string): Observable<any> {
    let formData: FormData = new FormData();
  ...
  postSendFileAndParametersDataBank(service: string, file: any, idPersona: any, idCuenta: any, idMandato: any, idAnexo: any, tipoMandato: any): Observable<any> {
    let formData: FormData = new FormData();
    if (file != undefined) {
      formData.append("uploadFile", file, file.name);
    }
  ...
  postSendFileAndParametersComprobantePago(service: string, file: any, idPersona: any, idInscripcion: any): Observable<any> {
    let formData: FormData = new FormData();
    if (file != undefined) {
      formData.append("uploadFile", file, file.name);
    }
