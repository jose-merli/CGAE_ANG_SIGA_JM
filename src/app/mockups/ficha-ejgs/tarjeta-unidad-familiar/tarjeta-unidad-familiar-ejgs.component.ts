...
export class TarjetaUnidadFamiliarEjgsComponent implements OnInit {
  ...
  elementos = [
    ['78900234T', "MARIA MAGDALENA", "C/ LA SERNA Nº 10", "SOLICITANTE", "JESUCRISTO DIOS MAGDALENA", "", 'No solicitado'],
    ['76564567P', "JESUS EL NAZARENO, MARIA TERESA", "C/ LA SERNA Nº 10", "SOLICITANTE", "JESUCRISTO DIOS MAGDALENA", "", 'No solicitado'],
  ];
  elementosAux = [
    ['78900234T', "MARIA MAGDALENA", "C/ LA SERNA Nº 10", "SOLICITANTE", "JESUCRISTO DIOS MAGDALENA", "", 'No solicitado'],
    ['76564567P', "JESUS EL NAZARENO, MARIA TERESA", "C/ LA SERNA Nº 10", "SOLICITANTE", "JESUCRISTO DIOS MAGDALENA", "", 'No solicitado'],
