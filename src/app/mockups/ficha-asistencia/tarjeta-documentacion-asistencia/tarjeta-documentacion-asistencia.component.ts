...
@Component({
  selector: 'app-tarjeta-documentacion-asistencia',
  templateUrl: './tarjeta-documentacion-asistencia.component.html',
  styleUrls: ['./tarjeta-documentacion-asistencia.component.scss']
})
export class TarjetaDocumentacionAsistenciaComponent implements OnInit {
  showResponse = true;
  msgs: Message[] = [];
  rowGroups: Row[];
  rowGroupsAux: Row[];
